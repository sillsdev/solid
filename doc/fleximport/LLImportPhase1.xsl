...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
   ...
   <xsl:template name="lexeme-form">
      ...
      <xsl:apply-templates select="*[name() != 'UnderlyingForm5002'][name() != 'CitationForm5002'][name() != 'Allomorphs5002']"/>
   </xsl:template>
   ...
   <xsl:template match="LexMinorEntry">
      <xsl:element name="LexEntry">
         ...
         <EntryType5002>
            <Link ws="en" name="Inflectional Variant"/>
         </EntryType5002>
   ...
   <xsl:template match="LexSubentry">
      <xsl:element name="LexEntry">
         <xsl:apply-templates select="@*" mode="detailed"/>
         <xsl:if test="SubentryType5007/Link[@target='ID7F713EA-E8CF-11D3-9764-00C04F186933']">
            <EntryType5002>
               <Link ws="en" name="Compound"/>
            </EntryType5002>
         </xsl:if>
         <xsl:if test="SubentryType5007/Link[@target='ID7F713EB-E8CF-11D3-9764-00C04F186933']">
            <EntryType5002>
               <Link ws="en" name="Derivation"/>
            </EntryType5002>
         </xsl:if>
         <xsl:if test="SubentryType5007/Link[@target='ID7F713EC-E8CF-11D3-9764-00C04F186933']">
            <EntryType5002>
               <Link ws="en" name="Idiom"/>
            </EntryType5002>
         </xsl:if>
         <xsl:if test="SubentryType5007/Link[@target='ID7F713ED-E8CF-11D3-9764-00C04F186933']">
            <EntryType5002>
               <Link ws="en" name="Keyterm Phrase"/>
            </EntryType5002>
         </xsl:if>
         <xsl:if test="SubentryType5007/Link[@target='ID7F713EE-E8CF-11D3-9764-00C04F186933']">
            <EntryType5002>
      ...
      <xsl:for-each select="Members5006/LexPairRelation">
         ...
         <xsl:if test="not (preceding::*[AName5011/AStr/Run = $aname][BName5011/AStr/Run = $bname])">
            <LexReferenceType>
               ...
               <xsl:if test="ancestor::LexicalRelationGroup/Members5006/LexPairRelation[AName5011/AStr/Run = $aname][BName5011/AStr/Run = $bname][Members5011]">
                  <Members5119>
                     <xsl:for-each select="ancestor::LexicalRelationGroup/Members5006/LexPairRelation[AName5011/AStr/Run = $aname][BName5011/AStr/Run = $bname]">
   ...
   <xsl:template name="Annotations">
      ...
      <xsl:if test="CmAnnotation/InstanceOf34/Link[@name = $trigger]">
         <xsl:element name="{$newelement}">
            <xsl:for-each select="CmAnnotation/Comment34/AStr[../../InstanceOf34/Link/@name = $trigger]">
               ...
               <xsl:if test="not (../../preceding-sibling::CmAnnotation/Comment34/AStr[../../InstanceOf34/Link/@name = $trigger][@ws = $thisws])">
                  <AStr>
                     <xsl:attribute name="ws">
                        <xsl:value-of select="@ws"/>
                     </xsl:attribute>
                     <xsl:for-each select="../../../CmAnnotation/Comment34/AStr[../../InstanceOf34/Link/@name = $trigger][@ws = $thisws]">
   ...
   <xsl:template match="Annotations5016">
      ...
      <xsl:if test="CmAnnotation/InstanceOf34/Link[@name != 'anthropology'][@name != 'discourse'][@name != 'grammar'][@name != 'phonology'][@name != 'semantics'][@name != 'sociolinguistics'][@name != 'encyclopedic'][@name != 'bibliography']">
         <GeneralNote5016>
   ...
   <xsl:template match="IsBodyWithHeadword5007 | SubentryType5007 | SubentryTypes5005 | CrossReferences5002 | LexicalRelations5016 | Sound5014 | SourceSegment5004"/>
