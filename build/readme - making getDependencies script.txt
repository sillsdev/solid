...
<your path to buildupdate.rb>\buildupdate.rb -t bt10 -f getDependencies-windows.sh -r ..

Explanation:

"-t bt10" points at the configuration that tracks this branch (in this case, the master branch)
