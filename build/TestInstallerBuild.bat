...
MSbuild /target:installer /property:teamcity_build_checkoutDir=..  /property:teamcity_dotnet_nunitlauncher_msbuild_task="notthere" /property:BUILD_NUMBER="0.1.345.abcd" /property:Minor="1"
